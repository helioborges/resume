...
class SocialNetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_network" do
    assert_difference("SocialNetwork.count") do
      post social_networks_url, params: { social_network: { icon: @social_network.icon, name: @social_network.name } }
    end
  ...
  test "should update social_network" do
    patch social_network_url(@social_network), params: { social_network: { icon: @social_network.icon, name: @social_network.name } }
